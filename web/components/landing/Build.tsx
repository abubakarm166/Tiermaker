      ...
      <div className="container">
        <div className="build_card_body_div">
          <div className="build_text_div">
            ...
            <p>
              Turn your ideas into shareable rankings, explore <br /> what others are creating, and join a growing <br /> community of list makers.
            </p>
            <Link href="/register">
              <button type="button">
                Start Building Your Tier List <ArrowRight size={18} />
              </button>
            </Link>
          </div>
