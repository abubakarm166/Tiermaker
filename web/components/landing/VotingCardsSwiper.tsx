            ...
            <SwiperSlide key={card.id}>
              <div className="voting_card_body">
                ...
                <div className="voting_card_images">
                  ...
                  <div className="voting_card_extra_count">+{card.extraCount}</div>
                </div>
                <div className="voting_card_footer">
                  <div className="voting_card_meta">
                    <div className="voting_card_meta_item">
                      <svg className="voting_card_meta_icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <button className="voting_card_vote_btn" type="button">
                    Cast Your Vote
