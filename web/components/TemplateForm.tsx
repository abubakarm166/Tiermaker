        ...
        <div>
          ...
          <ul className="space-y-2">
            {rows.map((r, i) => (
              <li
                key={i}
                className="flex items-center gap-3 p-2 rounded-xl border border-app bg-surface-elevated"
              >
                <span
                  className="inline-flex h-10 min-w-[72px] shrink-0 items-center justify-center rounded-lg px-3 text-sm font-semibold uppercase tracking-wide"
